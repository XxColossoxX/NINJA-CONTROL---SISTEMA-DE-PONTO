...
<div class="flex justify-center items-start min-h-[calc(100vh-64px)] pt-20 px-4">
  <div class="w-full max-w-6xl controlador hidden">
    ...
    <div class="flex justify-end mb-4">
      <!-- Botão desktop -->
      <button id="add-employee-btn" class="hidden sm:inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded-md transition">
